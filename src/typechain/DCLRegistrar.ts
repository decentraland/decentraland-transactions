...
export interface DCLRegistrarInterface extends utils.Interface {
  functions: {
    ...
    "forwardToResolver(bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "forwardToResolver",
  ...
  encodeFunctionData(
    functionFragment: "reclaim(uint256,address)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "reclaim(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "CallForwarwedToResolver(address,bytes,bytes)": EventFragment;
    ...
    "ResolverUpdated(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CallForwarwedToResolver"): EventFragment;
...
export interface CallForwarwedToResolverEventObject {
  _resolver: string;
  _data: string;
  res: string;
}
export type CallForwarwedToResolverEvent = TypedEvent<
  [string, string, string],
  CallForwarwedToResolverEventObject
>;

export type CallForwarwedToResolverEventFilter =
  TypedEventFilter<CallForwarwedToResolverEvent>;
...
export interface ResolverUpdatedEventObject {
  _oldResolver: string;
  _newResolver: string;
}
export type ResolverUpdatedEvent = TypedEvent<
  [string, string],
  ResolverUpdatedEventObject
>;

export type ResolverUpdatedEventFilter = TypedEventFilter<ResolverUpdatedEvent>;
...
export interface DCLRegistrar extends BaseContract {
  ...
  filters: {
    ...
    "CallForwarwedToResolver(address,bytes,bytes)"(
      _resolver?: PromiseOrValue<string> | null,
      _data?: null,
      res?: null
    ): CallForwarwedToResolverEventFilter;
    CallForwarwedToResolver(
      _resolver?: PromiseOrValue<string> | null,
      _data?: null,
      res?: null
    ): CallForwarwedToResolverEventFilter;
    ...
    "ResolverUpdated(address,address)"(
      _oldResolver?: PromiseOrValue<string> | null,
      _newResolver?: PromiseOrValue<string> | null
    ): ResolverUpdatedEventFilter;
    ResolverUpdated(
      _oldResolver?: PromiseOrValue<string> | null,
      _newResolver?: PromiseOrValue<string> | null
    ): ResolverUpdatedEventFilter;
