...
export declare namespace ThirdPartyRegistryV2 {
  ...
  export type ThirdPartyReviewParamStruct = {
    id: PromiseOrValue<string>;
    value: PromiseOrValue<boolean>;
    items: ThirdPartyRegistryV2.ItemReviewParamStruct[];
  };

  export type ThirdPartyReviewParamStructOutput = [
    string,
    boolean,
    ThirdPartyRegistryV2.ItemReviewParamStructOutput[]
  ] & {
    id: string;
    value: boolean;
    items: ThirdPartyRegistryV2.ItemReviewParamStructOutput[];
  };
}
...
export interface ThirdPartyRegistryInterface extends utils.Interface {
  functions: {
    ...
    "addThirdParties((string,string,string,address[],bool[],uint256)[])": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [ThirdPartyRegistryV2.ThirdPartyParamStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [
      PromiseOrValue<string>,
      ThirdPartyRegistryV2.ConsumeSlotsParamStruct[]
    ]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [ThirdPartyRegistryV2.ThirdPartyReviewParamStruct[]]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ThirdPartyAdded(string,string,string,bool,address[],uint256,address)": EventFragment;
...
export type ThirdPartyAddedEvent = TypedEvent<
  [string, string, string, boolean, string[], BigNumber, string],
...
export interface ThirdPartyRegistry extends BaseContract {
  ...
  functions: {
    ...
    addThirdParties(
      _thirdParties: ThirdPartyRegistryV2.ThirdPartyParamStruct[],
    ...
    consumeSlots(
      _thirdPartyId: PromiseOrValue<string>,
      _consumeSlotsParams: ThirdPartyRegistryV2.ConsumeSlotsParamStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    itemsById(
      ...
      overrides?: CallOverrides
    ): Promise<[ThirdPartyRegistryV2.ItemStructOutput]>;
    ...
    reviewThirdParties(
      _thirdParties: ThirdPartyRegistryV2.ThirdPartyReviewParamStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "ThirdPartyAdded(string,string,string,bool,address[],uint256,address)"(
      _thirdPartyId?: null,
      _metadata?: null,
      _resolver?: null,
      _isApproved?: null,
