...
export declare namespace Rarities {
...
export interface RaritiesInterface extends utils.Interface {
  functions: {
...
export interface AddRarityEventObject {
  _rarity: Rarities.RarityStructOutput;
}
export type AddRarityEvent = TypedEvent<
  [Rarities.RarityStructOutput],
...
export interface Rarities extends BaseContract {
  ...
  functions: {
    addRarities(
      _rarities: Rarities.RarityStruct[],
    ...
    getRarityByName(
      ...
      overrides?: CallOverrides
    ): Promise<[Rarities.RarityStructOutput]>;
